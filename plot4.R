...
plot(timeframe$Date2, as.numeric(timeframe$Global_active_power), type = "l", ylab="Global Active Power", xlab="")

plot(timeframe$Date2, as.numeric(timeframe$Voltage), type = "l", ylab="Voltage", xlab="datetime")
